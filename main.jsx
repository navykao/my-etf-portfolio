    ...
    if (hasFirebase && auth) {
      ...
      if (localData) {
        try {
          ...
          setInitialInvestment(parsed.initialInvestment || 50000);
          setMonthlyContribution(parsed.monthlyContribution || 3500);
          setContributionStepUp(parsed.contributionStepUp || 5);
          setInvestmentYears(parsed.investmentYears || 30);
