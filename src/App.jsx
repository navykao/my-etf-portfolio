  ...
  return (
    <div className="container" style={{ paddingTop: '24px' }}>
      ...
      <div className="card" style={{ marginBottom: '24px' }}>
        ...
        {formError && (
          <div style={{ color: 'var(--rose)', fontSize: '13px', marginTop: '8px', padding: '8px 12px', background: 'var(--rose-soft)', borderRadius: 'var(--r-md)', borderLeft: '3px solid var(--rose)' }}>
            ⚠️ {formError}
          </div>
        )}
      </div>
      ...
      {portfolio.length === 0 ? (
        <div className="card" style={{ textAlign: 'center', padding: '60px 20px' }}>
          ...
          <p style={{ color: 'var(--ink-4)', fontSize: '13px' }}>เพิ่มหุ้นด้วยฟอร์มด้านบน</p>
        </div>
      ) : (
        <>
          {/* Summary */}
